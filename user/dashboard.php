        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-3">
                <div class="card card-pn h-100 text-center p-4">
                    ...
                    <a href="<?php echo BASE_URL; ?>/user/ajukan-layanan.php" class="btn btn-sm btn-gold mt-2">Buka</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="card card-pn h-100 text-center p-4">
                    ...
                    <a href="<?php echo BASE_URL; ?>/user/status-pengajuan.php" class="btn btn-sm btn-gold mt-2">Buka</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="card card-pn h-100 text-center p-4">
                    ...
                    <h6>Jadwal Sidang</h6>
                    <a href="<?php echo BASE_URL; ?>/user/jadwal-sidang.php" class="btn btn-sm btn-gold mt-2">Buka</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="card card-pn h-100 text-center p-4">
                    ...
                    <h6>Pengaduan</h6>
                    <a href="<?php echo BASE_URL; ?>/user/pengaduan.php" class="btn btn-sm btn-gold mt-2">Buka</a>
                </div>
            </div>
        </div>
    </div>
